...
void SortPlotsWidget::InitButtons() {
  ...
  gui::PlainButton* bubble_button = new gui::PlainButton(glib::IntRect(50, 570, 162, 80), bubble_functor, bubble_skin);
  ...
  gui::PlainButton* merge_button = new gui::PlainButton(glib::IntRect(250, 570, 162, 80), merge_functor, merge_skin);
  ...
  gui::PlainButton* quick_button = new gui::PlainButton(glib::IntRect(450, 570, 162, 80), quick_functor, quick_skin);
  ...
  gui::PlainButton* selection_button = new gui::PlainButton(glib::IntRect(50, 688, 162, 80), selection_functor, selection_skin);
  ...
  gui::PlainButton* stdsort_button = new gui::PlainButton(glib::IntRect(250, 688, 162, 80), stdsort_functor, stdsort_skin);
  ...
  gui::PlainButton* stdstable_button = new gui::PlainButton(glib::IntRect(450, 688, 162, 80), stdstable_functor, stdstable_skin);
  ...
  gui::PlainButton* clear_button = new gui::PlainButton(glib::IntRect(650, 688, 162, 80), clear_functor, clear_skin);
